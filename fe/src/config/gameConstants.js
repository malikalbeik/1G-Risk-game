...
export const NEIGHBOURS = {
  ...
  central_america: {
    countries: ["venezuela", "eastern_united_states", "western_united_states"],
  },
  china: {
    countries: ["ural", "siberia", "afghanistan", "mongolia", "siam", "india"],
  },
  ...
  great_britain: {
    countries: ["western_europe", "iceland", "northern_europe", "scandinavia"],
  },
  greenland: {
  ...
  kamchatka: {
    countries: ["alaska", "yakutsk", "japan", "irkutsk", "mongolia"],
  },
